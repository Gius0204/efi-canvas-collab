...
const CreateCanvasModal: React.FC<CreateCanvasModalProps> = ({
  ...
  const handleCreateWithTemplate = (templateId: string) => {
    navigate(`/canvas/template/${templateId}?loadTemplate=true`);
    onClose();
  };
      ...
      <DialogContent className="sm:max-w-[600px] p-0">
        <div className="relative">
          {!showTemplates && !selectedTemplate && (
            <div className="p-6">
              <h2 className="text-center text-sm text-gray-500 mb-1">
                Bienvenido a Eficiente Board
              </h2>
              ...
              <div className="flex items-center justify-center mt-4">
                <button className="flex items-center text-sm text-primary hover:underline">
                  ...
                  Mira el video de introducción rápido para conocer Eficiente
                  Board
                </button>
              </div>
            </div>
              ...
              {selectedTemplateData && (
                <div className="mb-6">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Esta plantilla está diseñada para representar el proceso de
                    establecimiento de fortalezas, oportunidades, debilidades y
                    amenazas de una empresa o áreas respectivas
                  </p>
                  ...
                  <button
                    onClick={() =>
                      handleCreateWithTemplate(selectedTemplateData.id)
                    }
