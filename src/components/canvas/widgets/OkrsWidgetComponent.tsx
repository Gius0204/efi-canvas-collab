...
const OkrsWidgetComponent: React.FC<OkrsWidgetComponentProps> = ({
  onClose,
  onAddToCanvas,
}) => {
  const [items, setItems] = useState<OkrItem[]>([
    {
      id: "1",
      text: "Optimizar la gestión financiera para mejorar la rentabilidad y sostenibilidad de la empresa.",
      type: "objetivo",
    },
    {
      id: "2",
      text: "Reducir los costos operativos en un 15%",
      type: "keyResult",
    },
    {
      id: "3",
      text: "Disminuir en un 30% los errores en reportes financieros",
      type: "keyResult",
    },
    {
      id: "4",
      text: "Implementar un software de gestión financiera.",
      type: "iniciativa",
    },
  ]);
  ...
  const [activeType, setActiveType] = useState<
    "objetivo" | "keyResult" | "iniciativa" | null
  >(null);
  ...
  return (
    <Draggable>
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        <div className="bg-white rounded-lg shadow-lg w-[auto] max-w-4xl max-h-[80vh] overflow-auto">
          <div className="p-4">
                ...
                <div className="mb-4">
                  ...
                  {items
                    ...
                    .map((item) => (
                      <div
                        key={item.id}
                        className="bg-green-100 p-3 mb-2 rounded-md relative group"
                      >
                        <button
                ...
                <div className="mb-4">
                  ...
                  {items
                    ...
                    .map((item) => (
                      <div
                        key={item.id}
                        className="bg-blue-100 p-3 mb-2 rounded-md relative group"
                      >
                        <button
                          onClick={() => handleRemoveItem(item.id)}
                          className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 text-gray-400 hover:text-gray-600"
                ...
                <div>
                  ...
                  {items
                    ...
                    .map((item) => (
                      <div
                        key={item.id}
                        className="bg-yellow-100 p-3 mb-2 rounded-md relative group"
                      >
                        <button
                          onClick={() => handleRemoveItem(item.id)}
                          className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 text-gray-400 hover:text-gray-600"
